...
class ColorTheme {
  ...
  static Color darkBlue = Helper.hexToColor("#343641")!;
  static Color turquise = Helper.hexToColor("#cedad5")!;
  ...
  static const Color appBg =
      Colors.white; // Color.fromARGB(255, 245, 245, 245);

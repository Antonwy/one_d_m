...
typedef OpenBuilder = Widget Function(BuildContext context, VoidCallback action,
...
class CustomOpenContainer extends StatefulWidget {
  ...
  @override
  _CustomOpenContainerState createState() => _CustomOpenContainerState();
}
                  ...
                  return SizedBox.expand(
                    child: Material(
                      ...
                      child: Builder(
                        ...
                        builder: (BuildContext context) {
                          return openBuilder(
                              context, closeContainer, _scrollController);
                        },
                      ),
                    ),
                  );
